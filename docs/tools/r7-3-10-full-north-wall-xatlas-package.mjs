#!/usr/bin/env node
/*
 * R7-3.10 Phase 2 full north-wall XATLAS package helper.
 *
...
function finalizeOidnManifest(rawDir, oidnDir) {
	...
	const manifest = {
		...rawManifest,
		version: 'r7-3-10-xatlas-bake-c2-oidn-rt-high-beta-full-north-wall',
...
function main() {
	...
	const summary = {
		tool: 'r7-3-10-full-north-wall-xatlas-package',
