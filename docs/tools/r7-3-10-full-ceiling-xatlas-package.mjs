#!/usr/bin/env node
/*
 * R7-3.10 Phase 2 full ceiling XATLAS package helper.
 *
 * 天花板版（複製自 east 版，只改 runtimeScope / runtimeArchitecture / version / tool 字串）。
...
function finalizeOidnManifest(rawDir, oidnDir) {
	...
	const manifest = {
		...rawManifest,
		version: 'r7-3-10-xatlas-bake-c2-oidn-rt-high-beta-full-ceiling',
...
function main() {
	...
	const summary = {
		tool: 'r7-3-10-full-ceiling-xatlas-package',
