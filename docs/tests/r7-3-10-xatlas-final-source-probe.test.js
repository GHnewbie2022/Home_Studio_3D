...
assert.doesNotMatch(xatlasRuntimeApplyBody, /\bbreak\s*;/, 'xatlas first-hit apply block must not break before direct-light NEE');
assert.match(xatlasRuntimeApplyBody, /此處不可 break/, 'xatlas first-hit apply block must document the no-break direct-light guard');
