...
assert.match(fullRoomFallbackGuard, /!\(r7310NorthWallHybridFirstHit[\s\S]*r7310SeColumnNorthHybridFirstHit[\s\S]*r7310SouthWindowTopRevealShadowHybridFirstHit\)/);
